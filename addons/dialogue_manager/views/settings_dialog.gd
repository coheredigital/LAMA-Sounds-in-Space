...
@onready var errors_button := $Margin/VBox/TabBar/Editor/VBox/CheckForErrorsButton
@onready var store_compile_results_button := $Margin/VBox/TabBar/Editor/VBox/StoreCompileResultsButton
@onready var missing_translations_button := $Margin/VBox/TabBar/Editor/VBox/MissingTranslationsButton
@onready var continue_through_titles_button := $Margin/VBox/TabBar/Editor/VBox/ContinueThroughTitlesButton
@onready var wrap_button := $Margin/VBox/TabBar/Editor/VBox/WrapButton
@onready var include_all_responses_button := $Margin/VBox/TabBar/Runtime/VBox/IncludeAllResponsesButton
@onready var globals_list := $Margin/VBox/TabBar/Runtime/VBox/GlobalsList
...
func _on_SettingsDialog_about_to_show():
	...
	store_compile_results_button.button_pressed = settings.get_editor_value("store_compiler_results", true)
	missing_translations_button.button_pressed = settings.get_editor_value("missing_translations_are_errors", false)
	continue_through_titles_button.button_pressed = settings.get_editor_value("continue_through_titles", false)
	wrap_button.button_pressed = settings.get_editor_value("wrap_lines", false)
	include_all_responses_button.button_pressed = settings.get_runtime_value("include_all_responses", false)
	...
	globals_list.set_column_title(2, "Path3D")
