...
@export (float, 1.0, 8.0) var follow_speed = 3.0
@export (float, 1.0, 8.0) var turn_speed = 4.0
@export (float, 0.0, 10.0) var distance_buffer = 1.0
@export (float, 1.0, 10.0) var distance_boost = 2.0
...
#	DebugTools.set_text("Camera3D Distance", distance)
#	DebugTools.set_text("Follow Speed",  follow_distance_speed)
